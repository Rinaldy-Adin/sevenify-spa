...
export default function RequestJoin() {
  ...
  useEffect(() => {
    if (isJoined) {
      ...
      document.querySelector(".request-being-reviewed").style.display = "block";
      document.querySelector(".join-sevenify").style.display = "none";
      document.querySelector(".sevenifyplus-info").style.display = "block";
    } else {
      // Render the "Join Sevenify+" section
      document.querySelector(".request-being-reviewed").style.display = "none";
